 ...
 */
package Vista;
import Controlador.ControladorCattipoempleado;
 ...
 * @author Jnatn'h
 */
public class CatTipoempleado extends java.awt.Dialog {
    
    private ControladorCattipoempleado controlador;
    
    public void setController(ControladorCattipoempleado controller){
        this.controlador = controller;
        this.asignarlistener();
    }
    private void asignarlistener(){
        Textbusqueda.addKeyListener(getController());
        Cattipoempleado.addMouseListener(getController());
        nuevotipoempleado.addActionListener(getController());
        salircat.addActionListener(getController());
    }
    public ControladorCattipoempleado getController(){
    ...
    public void setTextBusqueda(JTextField Textbusqueda)
    {
     ...
     public JTable getCattipoempleado()
    {
        return Cattipoempleado;
    }
    public void setCattipoempleado(JTable Cattipoempleado){
    ...
    public JButton getNuevoTipoempleado(){
        return nuevotipoempleado;
    }
    public void setNuevoTipoempleado(JButton nuevotipoempleado){
        this.nuevotipoempleado = nuevotipoempleado;
    }
    ...
    /**
     * Creates new form CatTipoempleado
     * @param parent, una contenedor de primer nivel como lo es Frame. 
     * @param modal, si queremos que sea modal o no ... 
     */
    public CatTipoempleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        centraVentana();
        this.setTitle("Tipos de Empleado");
        this.setResizable(false);
        setController(new ControladorCattipoempleado(this));
    }
    ...
    private void initComponents() {
        ...
        Cattipoempleado = new javax.swing.JTable();
        salircat = new javax.swing.JButton();
        nuevotipoempleado = new javax.swing.JButton();
        header = new org.edisoncor.gui.panel.Panel();
        leyenda = new javax.swing.JLabel();

        setMaximumSize(new java.awt.Dimension(464, 422));
        setModal(true);
        ...
        Cattipoempleado.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        Cattipoempleado.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null},
                {null},
                {null},
        ...
        Cattipoempleado.setToolTipText("Tipo de empleado");
        Cattipoempleado.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Cattipoempleado.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                CattipoempleadoKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                CattipoempleadoKeyTyped(evt);
            }
        });
        jScrollPane1.setViewportView(Cattipoempleado);
        ...
        nuevotipoempleado.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/imagen/registrar.png"))); // NOI18N
        nuevotipoempleado.setText("Nuevo");
        nuevotipoempleado.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        nuevotipoempleado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nuevotipoempleadoActionPerformed(evt);
            }
        });

        header.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/imagen/header-cattipoempleado.png"))); // NOI18N
        ...
        catLayout.setHorizontalGroup(
            ...
            .addGroup(catLayout.createSequentialGroup()
                ...
                .addGroup(catLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(catLayout.createSequentialGroup()
                        .addComponent(nuevotipoempleado, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        catLayout.setVerticalGroup(
            ...
            .addGroup(catLayout.createSequentialGroup()
                ...
                .addGroup(catLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nuevotipoempleado, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void TextbusquedaFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TextbusquedaFocusGained
        String Leyend = "Buscar en el catálogo el registro de tipos de empleados. .. ";
    ...
    private void CattipoempleadoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CattipoempleadoKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_CattipoempleadoKeyReleased

    private void CattipoempleadoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CattipoempleadoKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_CattipoempleadoKeyTyped

    private void nuevotipoempleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevotipoempleadoActionPerformed

    }//GEN-LAST:event_nuevotipoempleadoActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable Cattipoempleado;
    ...
    private javax.swing.JButton nuevotipoempleado;
