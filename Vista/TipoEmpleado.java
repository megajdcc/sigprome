...
import Controlador.ControladorTipoEmpleado;
 ...
 * @author Jnatn'h
 */
public class TipoEmpleado extends java.awt.Dialog {
    
    int Idtipoempleado;
    
    ControladorTipoEmpleado controlador;
    ControladorCattipoempleado controladorcat;
    
     public void Idtipoempleado(int Idtipoempleado)
    {

        this.Idtipoempleado = Idtipoempleado;
        this.setIdTipoempleado(Idtipoempleado);
    ...
    public void setLeyenda(JLabel Leyenda)
    {
     ...
     public JTextField getTexttipoempleado ()
    {
        return Texttipoempleado;
    }
    public void setTexttipoempleado(JTextField Texttipoempleado)
    {
        this.Texttipoempleado = Texttipoempleado;
    }
     ...
     */
    public TipoEmpleado(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.Texttipoempleado.requestFocus();
        this.setResizable(false);
        this.setTitle("Tipo de Empleados");
        centraVentana();
    }
      ...
      private void validar(KeyEvent e)
{
    char b = e.getKeyChar();
         ...
         if( this.getTexttipoempleado().getText().length() >= 30)
    {
        e.consume();
    }
}
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(589, 238));
        setModal(true);
        ...
        panel1.setMaximumSize(new java.awt.Dimension(589, 238));

        panel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/imagen/header-tipoempleado.png"))); // NOI18N
        panel2.setMaximumSize(new java.awt.Dimension(589, 75));
        panel2.setPreferredSize(new java.awt.Dimension(589, 75));
        ...
        Texttipoempleado.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                TexttipoempleadoFocusGained(evt);
            }
        });
        Texttipoempleado.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TexttipoempleadoKeyTyped(evt);
            }
        });
        ...
        panel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                ...
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(Texttipoempleado, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE))
        ...
        controlador = new Controlador.ControladorTipoEmpleado(this);
    ...
    private void TexttipoempleadoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TexttipoempleadoFocusGained
        String leyen = "Ingrese o modifique los tipos de empleados";
        this.getLeyenda().setText(leyen);
    }//GEN-LAST:event_TexttipoempleadoFocusGained

    private void TexttipoempleadoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TexttipoempleadoKeyTyped
        this.validar(evt);
    }//GEN-LAST:event_TexttipoempleadoKeyTyped
