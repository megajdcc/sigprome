 ...
 * @author Jnatn'h
 */
public class Especialidad extends java.awt.Dialog {
ControladorEspecialidad controlador;
    int idespecialidad;
     public void Idespecialidad(int Idespecialidad)
    {
     ...
     */
    public Especialidad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        this.desabilitaroptionpegar(this.getTextespecialidad());
    }
 ...
 private void centraVentana() {
  ...
  private void initComponents() {
    ...
    setMaximumSize(new java.awt.Dimension(642, 237));
    ...
    panel1.setMaximumSize(new java.awt.Dimension(642, 237));
    panel1.setPreferredSize(new java.awt.Dimension(642, 237));

    panel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/imagen/header-especialidad.png"))); // NOI18N
    ...
    Textespecialidad.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
    Textespecialidad.addFocusListener(new java.awt.event.FocusAdapter() {
      public void focusGained(java.awt.event.FocusEvent evt) {
        TextespecialidadFocusGained(evt);
      }
    });
    ...
    panel1Layout.setVerticalGroup(
      ...
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
        ...
        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
          ...
          .addComponent(Textespecialidad, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE))
        .addGap(26, 26, 26)
    ...
    controlador = new Controlador.ControladorEspecialidad(this);
    ...
    private void TextespecialidadFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TextespecialidadFocusGained
        String leyen = "Ingrese o modifique la especialidad";
        this.getLeyenda().setText(leyen);
        this.getLeyenda().setForeground(Color.white);
    }//GEN-LAST:event_TextespecialidadFocusGained
   ...
   private void validarcampo(KeyEvent e)
    {
        String caracter  = this.getTextespecialidad().toString();
     char b = e.getKeyChar();
         if(!Character.isLetter(b) &&  b != KeyEvent.VK_SPACE){
            e.consume();
    }     
         if( this.getTextespecialidad().getText().length() >= 30)
    {
        e.consume();
    }
//        if(!caracter.isEmpty())
