 ...
 * @author Jnatn'h
 */
public class Examen extends java.awt.Dialog {
    
     ControladorExamen controlador;
    int idexamen;
     public void Idexamen(int Idexamen)
    {
    ...
    public JTextField getTextexamen ()
    {
        return Textexamen;
    }
    public void setTextexamen(JTextField Textexamen)
    {
        this.Textexamen = Textexamen;
    }
    ...
    public Examen(java.awt.Frame parent, boolean modal) {
        ...
        this.desabilitaroptionpegar(this.getTextexamen());
    }
...
private void centraVentana() {
  ...
  private void initComponents() {
    ...
    Textexamen = new javax.swing.JTextField();
    ...
    panel1.setMaximumSize(new java.awt.Dimension(642, 255));
    panel1.setPreferredSize(new java.awt.Dimension(642, 255));
    ...
    Textexamen.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
    Textexamen.addFocusListener(new java.awt.event.FocusAdapter() {
      public void focusGained(java.awt.event.FocusEvent evt) {
        TextexamenFocusGained(evt);
      }
    });
    Textexamen.addKeyListener(new java.awt.event.KeyAdapter() {
      public void keyTyped(java.awt.event.KeyEvent evt) {
        TextexamenKeyTyped(evt);
      }
    });
    ...
    panel1Layout.setVerticalGroup(
      ...
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
        ...
        .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
          ...
          .addComponent(Textexamen, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE))
        .addGap(26, 26, 26)
    ...
    controlador = new Controlador.ControladorExamen(this);
    ...
    private void TextexamenFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TextexamenFocusGained
        String leyen = "Ingrese o modifique el examen";
        this.getLeyenda().setText(leyen);
        this.getLeyenda().setForeground(Color.white);
    }//GEN-LAST:event_TextexamenFocusGained

    private void TextexamenKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TextexamenKeyTyped
        this.validarcampo(evt);
    }//GEN-LAST:event_TextexamenKeyTyped
 private void validarcampo(KeyEvent e)
    {
        String caracter  = this.getTextexamen().toString();
     char b = e.getKeyChar();
         if(!Character.isLetter(b) &&  b != KeyEvent.VK_SPACE){
            e.consume();
    }     
         if( this.getTextexamen().getText().length() >= 30)
    {
        e.consume();
    }
//        if(!caracter.isEmpty())
...
//        this.getTextpotencia().setText(caracter);
  ...
  private javax.swing.JTextField Textexamen;
