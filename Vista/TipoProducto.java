 ...
 * @author Jnatn'h
 */
public class TipoProducto extends java.awt.Dialog {
    
     int Idtipoproducto;
    
    ControladorTipoProducto controlador;
    ControladorCattipoproducto controladorcat;
    
     public void Idtipoproducto(int Idtipoproducto)
    {
    ...
    public void setLeyenda(JLabel Leyenda)
    {
     ...
     public JTextField getTexttipoproducto ()
    {
        return Texttipoproducto;
    }
    public void setTexttipoproducto(JTextField Texttipoproducto)
    {
        this.Texttipoproducto = Texttipoproducto;
    }
     ...
     */
    public TipoProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.Texttipoproducto.requestFocus();
        this.setResizable(false);
        this.setTitle("Tipo de Productos");
        centraVentana();
        
        this.desabilitaroptionpegar(this.getTexttipoproducto());
    }
      ...
      private void validar(KeyEvent e)
{
    char b = e.getKeyChar();
         ...
         if( this.getTexttipoproducto().getText().length() >= 30)
    {
        e.consume();
    }
}
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(636, 238));
        ...
        panel1.setMaximumSize(new java.awt.Dimension(636, 238));

        panel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/imagen/header-tipodeproducto.png"))); // NOI18N
        panel2.setMaximumSize(new java.awt.Dimension(635, 75));
        panel2.setPreferredSize(new java.awt.Dimension(635, 75));
        ...
        Texttipoproducto.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                TexttipoproductoFocusGained(evt);
            }
        });
        Texttipoproducto.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TexttipoproductoKeyTyped(evt);
            }
        });
        ...
        panel1Layout.setHorizontalGroup(
            ...
            .addComponent(panel2, javax.swing.GroupLayout.DEFAULT_SIZE, 636, Short.MAX_VALUE)
        ...
        panel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel1Layout.createSequentialGroup()
                ...
                .addGroup(panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(Texttipoproducto, javax.swing.GroupLayout.DEFAULT_SIZE, 35, Short.MAX_VALUE))
        ...
        controlador = new Controlador.ControladorTipoProducto(this);
    ...
    private void TexttipoproductoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TexttipoproductoFocusGained
        String leyen = "Ingrese o modifique el tipo de producto";
        this.getLeyenda().setText(leyen);
    }//GEN-LAST:event_TexttipoproductoFocusGained

    private void TexttipoproductoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TexttipoproductoKeyTyped
        this.validar(evt);
    }//GEN-LAST:event_TexttipoproductoKeyTyped
