 ...
 * @author Jnatn'h
 */
public class Tipousuario extends java.awt.Dialog {
    
     ControladorTipousuario controlador;
    int idtipousuario;
     public void Idtipousuario(int Idtipousuario)
    {
    ...
    public JTextField getTexttipousuario ()
    {
        return Texttipousuario;
    }
    public void setTexttipousuario(JTextField Texttipousuario)
    {
        this.Texttipousuario = Texttipousuario;
    }
    ...
    public Tipousuario(java.awt.Frame parent, boolean modal) {
        ...
        this.desabilitaroptionpegar(this.getTexttipousuario());
    }
 ...
 private void centraVentana() {
  ...
  private void initComponents() {
    ...
    setMaximumSize(new java.awt.Dimension(642, 240));
    setResizable(false);
    ...
    panel1.setMaximumSize(new java.awt.Dimension(642, 240));
    panel1.setPreferredSize(new java.awt.Dimension(642, 240));

    panel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vista/imagen/header-tipodeusuario.png"))); // NOI18N
    ...
    Texttipousuario.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
    Texttipousuario.addFocusListener(new java.awt.event.FocusAdapter() {
      public void focusGained(java.awt.event.FocusEvent evt) {
        TexttipousuarioFocusGained(evt);
      }
    });
    Texttipousuario.addKeyListener(new java.awt.event.KeyAdapter() {
      public void keyTyped(java.awt.event.KeyEvent evt) {
        TexttipousuarioKeyTyped(evt);
      }
    });
    ...
    controlador = new Controlador.ControladorTipousuario(this);
    ...
    private void TexttipousuarioFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TexttipousuarioFocusGained
        String leyen = "Ingrese o modifique el tipo de usuario";
        this.getLeyenda().setText(leyen);
        this.getLeyenda().setForeground(Color.white);
    }//GEN-LAST:event_TexttipousuarioFocusGained

    private void TexttipousuarioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TexttipousuarioKeyTyped
        this.validarcampo(evt);
    }//GEN-LAST:event_TexttipousuarioKeyTyped
 private void validarcampo(KeyEvent e)
    {
        String caracter  = this.getTexttipousuario().toString();
     char b = e.getKeyChar();
         if(!Character.isLetter(b) &&  b != KeyEvent.VK_SPACE){
            e.consume();
    }     
         if( this.getTexttipousuario().getText().length() >= 30)
    {
        e.consume();
    }
//        if(!caracter.isEmpty())
