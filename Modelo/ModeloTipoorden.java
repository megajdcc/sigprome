...
public class ModeloTipoorden {
    ...
    private JasperViewer jasperViewer;
     ...
     public ModeloTipoorden(){
           conexion = ModeloConexion.conexion;
     }
   public ModeloTipoorden(String nombre){
         conexion = ModeloConexion.conexion;
       this.nombre = nombre;
   };
    public ModeloTipoorden(String nombre, int id) {
          conexion = ModeloConexion.conexion;
        this.nombre = nombre;
        this.id = id;
    }
   public ModeloTipoorden(cattiporden cat)
   {
         conexion = ModeloConexion.conexion;
   }
   public String getNombre() {
    ...
    public boolean consultarModelo(String nombre){
            ...
            String sentenciaSQL = "SELECT * FROM tipoorden WHERE nombre='"+nombre+"';";
...
//            System.out.println(resultadoConsulta);
    ...
    public boolean incluirModelo(){
       ...
       // System.out.println(this.nombre);
        String sentenciaSql = "INSERT INTO tipoorden(nombre) VALUES('"+nombre+"');";
...
//            System.out.println(resultadoConsulta);
     ...
     public boolean modificarModelo(String nombre, int idtipoorden){
        ...
        String sentenciaSql = "UPDATE tipoorden SET nombre='"+nombre+"' WHERE id='"+idtipoorden+"';";
        int ejecutado;
      ...
      public boolean eliminarModelo(String nombre){
        ...
        String sentenciaSql = "DELETE FROM tipoorden WHERE nombre='"+nombre+"';";
        int ejecutado = conexion.ejecutarActualizacion(sentenciaSql);
      ...
      public String[][] FiltroTipoorden(String nombre){
       
            boolean statusConsulta=false;
            
            String sentenciaSQL = "SELECT nombre FROM tipoorden WHERE nombre LIKE '%"+nombre+"%'";
            //System.out.println("SQL.-"+sentenciaSQL);
            ResultSet resultadoConsulta = conexion.ejecutarConsulta(sentenciaSQL);
    ...
    //Filtrar busquedas en el catalogo de patologia... 
       public String[][] filtrartipoorden(String busqueda){

        String sentenciaSQL = "SELECT nombre FROM tipoorden WHERE nombre LIKE '%"+busqueda+"%';";
        ResultSet resultadoConsulta = conexion.ejecutarConsulta(sentenciaSQL);
 ...
 public String[][] consultarListaTipoorden(){
       
            boolean statusConsulta = false;
            
            String sentenciaSQL = "SELECT nombre FROM tipoorden";
            //System.out.println("SQL.-"+sentenciaSQL);
            ResultSet resultadoConsulta = conexion.ejecutarConsulta(sentenciaSQL);
